...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Chidi transformed how I manage my online store. I can finally focus on growing my business instead of drowning in customer messages.",
      name: "Amara Okonkwo",
      company: "Founder, StyleHub Boutique",
      image: "/placeholder.svg",
    },
    {
      quote:
        "The AI automation is incredible. Chidi handles 80% of my customer inquiries automatically, and my response time went from hours to seconds.",
      name: "Kwame Asante",
      company: "Owner, Artisan Crafts Co.",
      image: "/placeholder.svg",
    },
    {
      quote:
      ...
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            <div
              className="w-48 h-50 md:w-48 md:h-50 rounded-lg bg-gradient-to-br from-amber-100 to-orange-50 flex items-center justify-center transition-all duration-700 ease-in-out"
              style={{
            ...
            >
              <div className="w-20 h-20 rounded-full bg-[#37322F] flex items-center justify-center">
